...
var file_test_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x22, 0x1d, 0x0a, 0x07, 0x52,
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x38, 0x0a, 0x0b, 0x54, 0x65, 0x73, 0x74,
...
var file_test_service_proto_depIdxs = []int32{
	0, // 0: hello.TestService.Test:input_type -> hello.Request
	1, // 1: hello.TestService.Test:output_type -> hello.Response
...
func (c *testServiceClient) Test(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/hello.TestService/Test", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TestService_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.TestService/Test",
	}
